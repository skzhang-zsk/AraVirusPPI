...
parser = argparse.ArgumentParser(description="Generate ESM1b/2 protein embeddings")
parser.add_argument("-m", "--model", required=True, type=str, help="ESM1b/2 model file")
